...
class ThemeAdminService
{
    ...
    public static function ThemeAdminDataUrl($params = [])
    {
        // 链接数据
        $data = [
            'themedata'          => MyUrl('tenants/themedata/saveinfo', ['is_theme_data_admin' => 1]),
            'goods'              => MyUrl('tenants/goods/saveinfo', ['is_theme_data_admin' => 1]),
            'goods_category'     => MyUrl('tenants/goodscategory/index', ['is_theme_data_admin' => 1]),
            'brand'              => MyUrl('tenants/brand/saveinfo', ['is_theme_data_admin' => 1]),
            'brand_list'         => MyUrl('tenants/brand/index', ['is_theme_data_admin' => 1]),
            'article'            => MyUrl('tenants/article/saveinfo', ['is_theme_data_admin' => 1]),
            'article_list'       => MyUrl('tenants/article/index', ['is_theme_data_admin' => 1]),
            'article_category'   => MyUrl('tenants/articlecategory/index', ['is_theme_data_admin' => 1]),
            'link_list'          => MyUrl('tenants/link/index', ['is_theme_data_admin' => 1]),
            'navigation_header'  => MyUrl('tenants/navigation/index', ['type' => 'header', 'is_theme_data_admin' => 1]),
            'navigation_footer'  => MyUrl('tenants/navigation/index', ['type' => 'footer', 'is_theme_data_admin' => 1]),
            'slide_list'         => MyUrl('tenants/slide/index', ['is_theme_data_admin' => 1]),
            'store_config'       => MyUrl('tenants/config/store', ['is_theme_data_admin' => 1]),
            'user_login'         => MyUrl('tenants/site/index', ['nav_type' => 'login', 'is_theme_data_admin' => 1]),
            'user_register'      => MyUrl('tenants/site/index', ['nav_type' => 'register', 'is_theme_data_admin' => 1]),
            'user_forget'        => MyUrl('tenants/site/index', ['nav_type' => 'forgetpwd', 'is_theme_data_admin' => 1]),
            'screening_price'    => MyUrl('tenants/screeningprice/index', ['is_theme_data_admin' => 1]),
            'site_base'          => MyUrl('tenants/site/index', ['nav_type'=>'base', 'switch'=>'site-base', 'is_theme_data_admin' => 1]),
            'site_filing'        => MyUrl('tenants/site/index', ['nav_type'=>'base', 'switch'=>'site-filing', 'is_theme_data_admin' => 1]),
        ];
